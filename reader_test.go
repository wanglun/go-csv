...
`,
		...
		Name:             "MultiBytesCommaAndComment1",
		Input:            "a *b,c * \td,e\n;; comment\n",
		Output:           [][]string{{"a", "b,c", "d,e"}},
		TrimLeadingSpace: true,
		Comma:            []byte(" *"),
		...
		Name:             "MultiBytesCommaAndComment2",
		Input:            "a\x01\x02b,c\x01\x02 \td,e\n\x05\x06 comment\n",
		Output:           [][]string{{"a", "b,c", "d,e"}},
		TrimLeadingSpace: true,
		Comma:            []byte("\x01\x02"),
		Comment:          []byte("\x05\x06"),
	}, {
	...
	for _, tt := range tests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			r.DisableQuote = tt.DisableQuote
